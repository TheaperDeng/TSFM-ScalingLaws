...
sys.path.append("/u/jdeng3/oats/TSFM-ScalingLaws/TimeCraft/TimeDP")
...
def load_model(ckpt_path: str, config_path: str = None, device: str = 'cuda', seed: int = 0, **kwargs):
    ...
    if config_path is None:
        config_path = '/u/jdeng3/oats/TSFM-ScalingLaws/TimeCraft/TimeDP/configs/multi_domain_timedp_local.yaml'
        # config_path = '/scratch/amlt_code/TimeCraft/TimeDP/configs/multi_domain_timedp.yaml'
...
def main(model, data, index=0):
    ...
    for dataset in data.key_list:
        ...
        test_prompt = np.load(f'/work/nvme/bdaj/jdeng3/extracted_label_patches_{dataset_name}.npy')[index].reshape(320,)
    ...
    for key, value in generated_samples.items():
        torch.save(value[0], f"/u/jdeng3/oats/TSFM-ScalingLaws/batch_{key}_generated.pt")
...
if __name__ == '__main__':
    ...
    ckpt_path = "/work/nvme/bdaj/jdeng3/000060-0.0853.ckpt"
